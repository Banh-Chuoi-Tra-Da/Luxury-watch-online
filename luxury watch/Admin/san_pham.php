...
?>
<?php
	if(isset($_POST['thuc_hien_them_san_pham'])){
		...
		<?php
			if(isset($_GET['quanly'])=='capnhat'){
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="submit" name="capnhatsanpham" value="Cập nhật sản phẩm" class="btn btn-secondary">
				</form>
				</div>
			<?php
			}else{
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="submit" name="themsanpham" value="Thêm sản phẩm" class="btn btn-secondary">
				</form>
				</div>
				<?php
			} 
			...
			<div class="col-md-8">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><a onclick="javascript:return confirm('Bạn muốn xóa bản ghi');" href="?xoa=<?php echo $row_sp['sanpham_id'] ?>">Xóa</a> || <a href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_sp['sanpham_id'] ?>">Cập nhật</a></td>
					</tr>
				<?php
					} 
					?> 
