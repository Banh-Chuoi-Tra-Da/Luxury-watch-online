<!-- The Github_OAuth_Client is a custom PHP library that handles GitHub REST API calls for OAuth-related requests -->
	...
	*/ 
    ...
    public function apiRequest($access_token_url){ 
        ...
        $context  = stream_context_create([ 
          'http' => [ 
            'user_agent' => 'Vu GitHub OAuth Login', 
    ...
    public function getAuthenticatedUser($access_token) { 
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'Vu GitHub OAuth Login'); 
