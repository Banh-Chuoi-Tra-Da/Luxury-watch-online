...
$sp_chi_tiet = $_GET['id'];
$soluong_them = 1;
$sql_sp = "SELECT * FROM `tbl_san_pham` as sp JOIN `tbl_nha_cung_cap` as ncc on sp.manhacungcap=ncc.manhacungcap JOIN sp_theo_gt ON sp.ma_sp_theo_gt=sp_theo_gt.ma_sp_theo_gt 
...
$sql_binh_luan = "SELECT * FROM `binh_luan` as bl JOIN tbl_nguoi_dung as nd on bl.email=nd.email 
