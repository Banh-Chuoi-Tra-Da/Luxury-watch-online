                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <a href="chi_tiet_san_pham.php?id= <?php echo $sp['masanpham']; ?>">
                            <img class="img-responsive zoom-img"
                                src="https://www.casio.com/content/dam/casio/product-info/locales/vn/vi/timepiece/product/watch/G/GM/GM1/gm-110earth-1a/assets/GM-110EARTH-1A.png.transform/main-visual-pc/image.png"
                                class="img-responsive" style="height:100px;" alt="Image">
                    ...
                    <div class="panel-footer">
                        <h4><a class="item_add" href="#"><i></i></a> <span
                                class=" item_price">$<?php echo $sp['dongia']; ?></span></h4>
                    </div>
                </div>
            </div>
            <?php
