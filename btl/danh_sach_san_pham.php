...
//     while ($san_pham = $ketquatruyvan->fetch_assoc()){
//         var_dump($san_pham);
//         echo "<br>";
//     }
// }
...
?>
            <tr>
                ...
                <td>
                        <a class="btn btn-info" href="sua_san_pham.php?id=<?php echo $loaisanpham['masanpham'];?>">Sửa</a>  
                        <a class="btn btn-danger" href="xoa_san_pham.php?id=<?php echo $loaisanpham['masanpham'];?>">Xóa</a>
                </td>
            </tr>
<?php
        $i++;
